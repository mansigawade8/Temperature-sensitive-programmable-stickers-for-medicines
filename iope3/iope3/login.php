...
if (isset($_POST['register_submit'])) {
    ...
    $check_email = mysqli_query($con, "SELECT name FROM users where name = '$name' ");
if(mysqli_num_rows($check_email) > 0){
    echo '<script>alert("User Name Already Exists!!!....Try Againn")</script>';
}else{
    $insert_sql = "INSERT INTO users(name,password,email,contact,cpassword) VALUES('$name','$password','$email','$contact','$cpassword')";
